...
class BasicModel(torch.nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.conv5 = nn.Sequential(
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=self.output_channels[3], out_channels=128, kernel_size=3, stride=1, padding=1),
            nn.ReLU(inplace=True),
        ...
        self.conv6 = nn.Sequential(
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=self.output_channels[4], out_channels=128, kernel_size=3, stride=1, padding=1),
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=128, out_channels=self.output_channels[5], kernel_size=3, stride=1, padding=0)
        )
